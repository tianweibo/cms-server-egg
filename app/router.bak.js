...
module.exports = app => {
  ...
  router.get('/api/application/detail',new Auth(1).check,controller.application.detail);//应用详情的查看
  ...
  router.get('/api/application/indicatorNum',new Auth(1).check,controller.application.indicatorNum);//应用下是否有指标
  ...
  //标签
  router.post('/api/label/list',new Auth(1).check,controller.theLabel.list);// 标签的列表的获取
