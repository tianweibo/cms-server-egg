module.exports = app => {
  ...
  //事件
  router.post('/api/event/eventNames',controller.event.eventNames);// 通过event_code获取event_name
  ...
  router.get('/api/application/eventNamesOfCode',controller.application.eventNamesOfCode);// 通过application_code获取event_name的枚举
  //指标
