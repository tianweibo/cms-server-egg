...
module.exports=app=>{
	...
	const application=app.model.define('application',{
		...
		platform_business:{type:STRING(255),comment:'应用平台'},
		platform_business_label:{type:STRING(255),comment:'应用平台label'},     
		application_dep_platform:{type:STRING(255),comment:'应用部署平台'}, 
		application_dep_platform_label:{type:STRING(255),comment:'应用部署平台label'},  
		application_type:{type:STRING(255),comment:'应用类型'},  
		application_type_label:{type:STRING(255),comment:'应用类型label'},  
